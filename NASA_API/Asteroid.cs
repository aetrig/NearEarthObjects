...
public class Asteroid
{
	...
	public override string ToString()
	{
		...
		close approach date: {close_approach_data[0].close_approach_date_full}
		approach velocity (km/s): {close_approach_data[0].relative_velocity.kilometers_per_second}
		miss distance (km): {close_approach_data[0].miss_distance.kilometers}
		orbiting body: {close_approach_data[0].orbiting_body}
		";
	}
}
